...
for (let i = 0; i < no_of_Buttons; i++) {
  document.querySelectorAll(".drum")[i].addEventListener("click", function() {
    ...
    button_animation(button_clicked);
  });
}
// to detect key pressed on keyboard
...
function button_animation(curr_key) {
  active_button = document.querySelector("." + curr_key);
